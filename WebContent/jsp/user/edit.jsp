...
<form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/user_update.action" onsubmit="javascript:return confirm('您确认要提交表单吗？');">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-6">
      <input type="text" class="form-control" id="firstname" placeholder="请输入用户名称" name="user_name" readonly="true" value="${editUser.user_name }">
    </div>
  </div>
   <div class="form-group">
    <label for="firstname" class="col-xs-3 control-label">用户密码</label>
    <div class="col-xs-6">
      <input type="text" class="form-control" id="firstname" placeholder="请输入用户密码" name="user_password" readonly="true" value="${editUser.user_password }">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-6">
      <input type="text" class="form-control" id="lastname" name="user_money" value="${editUser.user_money }">
    </div>
  </div>
